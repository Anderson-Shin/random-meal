(function () {
  ...
  const translations = {
    en: {
      ...
      exploreLabel: "Explore", districtsHeading: "Popular districts", districtExplore: "Explore district guide", footerText: "A simple, manually curated way to decide what to eat in Hong Kong.", recommended: "Recommended for",
    ...
    zhHant: {
      ...
      exploreLabel: "探索", districtsHeading: "熱門地區", districtExplore: "查看地區指南", footerText: "以簡單、人工整理的方式決定在香港吃甚麼。", recommended: "推薦場合",
    ...
    zhHans: {
      ...
      exploreLabel: "探索", districtsHeading: "热门地区", districtExplore: "查看地区指南", footerText: "以简单、人工整理的方式决定在香港吃什么。", recommended: "推荐场合",
